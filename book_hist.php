...
<li><a href="viewhalls.php">VIEW CARS</a></li>
<li><a href="bookings.php">CHECK BOOKINGS</a></li>
<li><a href="add_halls.php">ADD CARS</a></li>
<li><a href="update_halls.php">UPDATE CARS</a></li>
<li><a href="delete_halls.php">REMOVE CARS</a></li>
<li class="active"><a href="book_hist.php">BOOKING HISTORY</a></li>
...
<?php
$sql="SELECT b_id, c_id, username, booked_date, status FROM b_cars";
